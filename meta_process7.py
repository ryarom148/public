...
sas_modules = {
    ...
    %let global_var1 = "path";

    %let local_var25 = "folder";
    data _null_;
        var1 = 5;
        var2 = 10;
        var3 = 15;
        call symput('macro_var1', var1);
        call symput('macro_var2', var2);
        call symput('macro_var3', var3);
    run;
    """,
    'module2.sas': """
    %include '/modules';
    %include "&local_var25./macros";
    %let local_var63 = local_var25;
    %let xren = global_var1;
    %let xren1 = 0;
    %let &xren1 = &local_var63;
    data _null_;
        call symput('macro_var1', var1);
        call symputx('macro_var2', var2, 'L');
    run;
    """,
    'module3.sas': """
    %include 'module1.sas';
    ...
    data _null_;
        %let local_var1 = 10;
        var5 = var4 + 20;
        %include "&global_var1./macros/cresn.sas";
        %let global_var2 = 75;

        call symput('macro_var5', var5);
    run;
    """
}

parser = SASParser(sas_modules)
import_statements_all = parser.get_all_metadata()
print("Import statements for all modules:")
print(import_statements_all)

import_statements_module2 = parser.get_module_comprehensive_metadata('module6.sas')
print("\nImport statements for module2.sas:")
print(import_statements_module2)
